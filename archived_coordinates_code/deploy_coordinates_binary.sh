...
go_binary="get-coordinates"  # Compiled Go binary
...
deploy_coordinate_binary() {
  for container in "${containers[@]}"; do
    ...
    echo "Copying get-coordinate binary to $container..."
    ...
    echo "get-coordinate binary successfully set up on $container."
  done
}
